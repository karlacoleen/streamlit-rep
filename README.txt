...
to make sure 3.9: conda create -n myenv python=3.9
...
8. Run "jupyter notebook" and you should be able to run your Jupyter notebooks by now. 
9. When you are done coding, exit Jupyter and type "conda deactivate" in your terminal. 
10. Repeat step 4 onwards when you will start coding again.

In case of questions, ask your mentor/instructor. Happy coding!

anaconda: conda install --file requirement.txt